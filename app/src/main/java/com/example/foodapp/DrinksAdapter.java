...
public class DrinksAdapter extends RecyclerView.Adapter<DrinksAdapter.myviewholder>
{
    ...
    public DrinksAdapter(ArrayList<DrinksDataModel> DataHolder) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_card_view_for_drinks,parent,false);
